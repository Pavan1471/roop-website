...
const rhinoplasty: PageData = {
  ...
  subtitle: 'Expert Nose Reshaping Surgery by Qualified Aesthetic Surgeons',
  ...
  secondSection: {
    ...
    description:
      '<strong>Congenital Defects:</strong> Secondary cleft lip nose deformity, cleft nose deformity, Binder\'s Syndrome and other birth defects can be corrected through rhinoplasty. <strong>Traumatic Injuries:</strong> Post-trauma nasal deformities and disruption of normal nose structure making the nose asymmetrical due to accidents or injuries. <strong>Cosmetic Concerns:</strong> Hump correction, dorsal hump removal, length correction, decrease in height of nose, and overall facial harmony improvement when the shape and contours of the nose do not synchronize with the rest of your face. <strong>Functional & Structural Issues:</strong> Correction of deviated nasal septum with crooked or off-center dorsum, breathing problems due to structural issues, damaged valves causing breathing difficulties, and nasal airway obstruction.',
    features: [
      '<strong>Nasal Tip Reshaping in Roop</strong> addresses drooping, rotating, boxy, bulbous or bifid nasal tips for a refined, balanced appearance. Excessively flared or pinched nostrils can also be corrected. <strong>Cartilage Grafting in Rhinoplasty</strong> uses patient\'s own cartilage from septum, ear, or rib to produce successful rhinoplasty outcomes with cosmetically pleasing skeletal contour and durable skeletal support to maintain that contour over time.',
      '<strong>Ideal Candidates</strong> for rhinoplasty are physically healthy, medically fit, psychologically stable individuals. Cosmetic rhinoplasty is usually suggested only after facial growth is completed - after 16-18 years of age. Patients should have realistic expectations about surgical outcomes and understand that actual results will be similar but not exactly the same as computer simulations. The nose is the central feature of the face, and a well-done procedure can bring about tremendous changes to overall facial features.',
    ],
  },
  ...
  procedure: {
    steps: [
      {
        title: 'Consultation & Pre-Operative Preparation',
        description: [
      ...
      {
        title: 'Surgical Procedure & Techniques',
        description: [
  ...
  faqs: [
    {
      question: 'Who is the right candidate for rhinoplasty?',
      answer:
        'A good candidate for rhinoplasty is anyone who is physically healthy, medically fit and psychologically stable. Cosmetic rhinoplasty is usually suggested only after facial growth is completed, that is after 16-18 years of age. Patients should have realistic expectations about surgical outcomes and understand the benefits, risks, and possible realistic outcomes of the procedure.',
    },
    {
      question: 'What is the difference between open and closed rhinoplasty?',
      answer:
        'In Closed Rhinoplasty, the nose is approached via entirely internal incisions with no external visible scars. Localized corrections such as hump reduction and bridge augmentations can be achieved. In Open Rhinoplasty, a small external incision is made to enable access under direct vision to all areas of the nose. Comprehensive rhinoplasties where changes are planned in most areas are best done by the open approach. The external scar is barely visible by 3 weeks.',
    },
    {
      question: 'What is the recovery time and when will I see final results?',
      answer:
        'The new shape is clearly apparent after 2-3 weeks, but swelling may take several weeks to months to completely subside. A nasal splint is usually removed at 6-7 days. Most patients return to normal activities by 2 weeks. Sports and strenuous activities should be avoided for 6 weeks. Complete refinement takes up to a year. Minor corrections may sometimes be necessary after 6 months to 1 year.',
    },
    {
      question: 'What are the risks and possible complications?',
      answer:
        'Postoperative swelling, skin bruising around eyes, postnasal drip and nasal stuffiness are common and vary with individuals. In patients with thick and oily nasal skin, swelling may remain longer. Smoking can result in poor healing and prolonged swelling. All patients must understand that sometimes results may not meet expectations and a secondary procedure may be necessary. Regular follow-ups with your surgeon are essential to monitoring progress.',
    },
    {
      question: 'What can be corrected with rhinoplasty?',
      answer:
        'Rhinoplasty can modify a disproportionately sized nose through reduction or augmentation, correct nasal hump or bridge depression, straighten a crooked or deviated nose, refine or reshape the nasal tip, improve overall nasal contours, address breathing problems due to deviated nasal septum, correct post-trauma nasal deformities, and treat congenital birth defects like cleft nose deformity.',
    },
  ],
